...
const fallbackUrl = 'https://rpmqpxtryrlsdsijwipm.supabase.co';
const fallbackKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJwbXFweHRyeXJsc2RzaWp3aXBtIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTMzMzUwNjMsImV4cCI6MjA2ODkxMTA2M30.iLRBzB2alt_KO5fa2hBkE1QgnUd1o6iRGnkOYBZzbyc';

const finalUrl = supabaseUrl || fallbackUrl;
const finalKey = supabaseAnonKey || fallbackKey;

console.log('🔧 Using URL:', finalUrl);
console.log('🔧 Using Key:', finalKey ? `${finalKey.substring(0, 20)}...` : 'NOT SET');
...
export const testDirectConnection = async () => {
    ...
    try {
        ...
        console.log('✅ Direct connection successful, found', result.data?.length || 0, 'services');
