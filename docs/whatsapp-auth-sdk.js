...
class WhatsAppAuthSDK {
    constructor(config = {}) {
        this.baseURL = config.baseURL || 'https://rpmqpxtryrlsdsijwipm.supabase.co';
        this.anonKey = config.anonKey || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJwbXFweHRyeXJsc2RzaWp3aXBtIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTMzMzUwNjMsImV4cCI6MjA2ODkxMTA2M30.iLRBzB2alt_KO5fa2hBkE1QgnUd1o6iRGnkOYBZzbyc';
        this.userJWT = null;
    }
    ...
    validatePhoneNumber(phone) {
        ...
        return {
            ...
            error: phoneRegex.test(phone) ? null : 'Phone number must be in international format (+256758361967)'
        };
    }
...
// Verify OTP
const verifyResult = await auth.verifyOTP('+256758361967', '123456');
